                ...
                <div className="row mb-5 d-flex justify-content-center">
                    ...
                    <div className="col-9 m-5 p-5">
                        <p className="f-1">
                            ...
                            >
                                What you are seeing now is my portfolio, The work of the last 4+ years of my life, and explanations on a lot of what I did, my interests and experiences, my passions, and things I care about. <br></br>
                                First, My introduction is that I am a passionate programmer, I love problem-solving and finding ways to do things I did not previously know I could do, and I probably like debugging more than I should. Besides that, however, I also have an inner artist in me that I cannot seem to suppress. I found the interactive media major in my undergrad to be an outlet for my artistic self, a way to express, create, and show a part of me one cannot see in a program with a set output requirement. <br></br>
